...
function PInfor({ onSubmit = () => {} }) {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:8080/PInfor', {
            PID: parseInt(formData.patientId), 
            DID: parseInt(formData.doctorId),
    ...
    return (
        <PatientForm>
            ...
            <form onSubmit={handleSubmit}>
                <FormLabel>
                    Patient ID:
                    <FormInput type="text" name="patientId" value={formData.patientId} onChange={handleInputChange} required/>
                </FormLabel>
                <FormLabel>
                    Doctor ID:
                    <FormInput type="text" name="doctorId" value={formData.doctorId} onChange={handleInputChange} required/>
                </FormLabel>
                <FormLabel>
                    First Name:
